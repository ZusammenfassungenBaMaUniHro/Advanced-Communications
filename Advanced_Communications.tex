...
\begin{itemize}
	...
	%TODO - "Details folgen" -> wo gibt es mehr dazu?? -> Verlinken oder hier einfügen
\end{itemize}
...
%TODO Was will er uns mit Folie 16 aus 180 sagen??
% 150, 180
...
% 220, 230
%TODO WWW und HTTP [Reserviert für Marc]
...
%TODO will hier noch jemand eine Liste mit weiteren Beispielen?


%\subsubsection{Caching}

%TODO HTTP Caching optional
...
%\begin{multicols}{2}
%TODO Multicols wieder aktivieren?
\begin{description}
...
\begin{center}
	\includegraphics[width=16cm]{img/rapr.png}
\end{center}	


Ein BootP-Protokoll-Paket enthält neben den selbsterklärenden einleitenden Feldern, die IP-Adress-Informationen von BootP-Client, -Server und Router, sowie die vom BootP-Server vorgeschlagene IP-Adresse für den Client. Darüber hinaus hat das BootP-Frame Datenfelder für den Client-Hardwareadresse, den Server-Host-Namen, den Boot-File-Namen und ein herstellerspezifisches Feld.  
\subsubsection{DHCP}
...
%TODO Qualitätskontrolle für den gesamten Abschnitt nötig, Folien geben nicht viel her!
% 320
\subsection{Telnet}
