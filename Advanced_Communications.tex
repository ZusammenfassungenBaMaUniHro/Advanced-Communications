...
SCTP ermöglicht multi-streaming, Daten können in parallelen Streams übertragen werden. Streams werden einzeln nummeriert (Retransmits müssen nur für den jeweiligen Stream erfolgen).
...
Das Verification Tag wird vom Empfänger genutzt, um den Sender des Pakets zu validieren.
...
Wenn ein Paket einen \texttt{SHUTDOWN COMPLETE Chunk}, 
