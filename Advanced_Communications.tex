...
\noindent Geräte und Verbindungen:
	\begin{itemize}
	...
	\item Base Station – Verbindet drahtloses Netzwerk mit kabelgebundenen Netzwerken. Koordiniert häufig die 2Stationen in ihrem Bereich. 
	\end{itemize}	
\subsection{Charakteristika}
\textbf{von drahtlosen Netzwerken:}
	\begin{itemize}
	...
	\textit{(WLAN mit Access Points, UMTS)}
	\item Single-hop, infrastructure-less \\
	\textit{(Bluetooth, WLAN im  ad-hoc Modus)}
	\item Multi-hop, infrastructure-based \\
	\textit{(Wireless Mesh Networks, Sensor Networks )}
	\item Multi-hop, infrastructure-less\\
	\textit{(Mobile ad-hoc networks (MANET), Vehicular ad-hoc networks (VANET))}
	\end{itemize}
\textbf{von Links(?)}
	\begin{itemize}
