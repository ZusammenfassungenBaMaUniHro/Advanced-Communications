...
Identifier und Sequence Number (ICMP-Felder; Gestatten dem Sender eine Zuordnung von replys bei mehreren Requests) werden vom Sender eingetragen und vom Empfänger in die Antwort kopiert.
Gestattet dem Sender eine Zuordnung von replys bei mehreren Requests
