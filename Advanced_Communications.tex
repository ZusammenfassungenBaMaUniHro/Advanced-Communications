...
\begin{algorithmic}
	...
	\EndWhile
\end{algorithmic}
\textbf{Verbale Beschreibung: } %TODO Dijkstra verbal
...
Beim Distance-Vector-Routing wird lediglich die Routing-Tabelle eines Knotens an 
...
Diese handeln "Options" aus (z.B. Character Set, Binary Transmission, Echo,Status, Timing Mark Option usw.)
