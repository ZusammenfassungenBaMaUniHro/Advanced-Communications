...
Begriff \emph{Mobilfunk} setzt sich zusammen aus den Aspekten:
%OPTIONAL Einrückung der Listen
\begin{description}
	\item[Mobil] \begin{itemize}
		\item Wechsel von Funkzellen
		\item Routing
	\end{itemize}
	\item [Funk] \begin{itemize}
		\item Störungen
		\item Hidden Stations
		\item Sicherheit
	\end{itemize}
\end{description}

\subsection{Geräte und Verbindungen, Charakteristiken}
\begin{description}
	\item[Wireles Host] | kann mobil sein oder nicht
	\item[Wireless Link] | Verbindung mit bestimmten Eigenschaften, wie Datenrate und Reichweite
	\item[Base Station] | Verbindet drahtloses Netzwerk mit kabelgebundenen Netzwerken.
	Koordiniert häufig die Stationen in ihrem Bereich
\end{description}
\begin{itemize}
	\renewcommand{\labelitemi}{$\Rightarrow$}
	\item Hosts, die mit einer Base Station assoziiert sind, arbeiten in einem Modus, den man häufig ßtextbf{Infrastruktur-Modus} nennt.
	\item Ohne Base Station spricht man häufig vom \textbf{Ad-hoc-Modus}.
	\item Den Wechsel von einer Base Station zu einer anderen nennt man \textbf{Handjob}.
\end{itemize}
...
%TODO Grafik Technologien 370-5
